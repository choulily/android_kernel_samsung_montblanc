HOW TO BUILD KERNEL 3.4.39 FOR SM-W2014
...
1. How to Build
	...
	- make
			$ export ARCH=arm
			$ make VARIANT_DEFCONFIG=msm8974_sec_montblanc3g_ctc_defconfig msm8974_sec_defconfig
			$ make
			
	- Execute : ./make_kernel_montblanc.sh
...
3. How to make .tar binary for downloading into target.
	...
	$ tar cvf SM-W2014_Kernel.tar zImage
