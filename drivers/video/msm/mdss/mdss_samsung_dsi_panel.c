			       ...
			       struct mdss_panel_common_pdata *panel_data)
{
	...
	mdss_samsung_parse_panel_cmd(pdev, &nv_mtp_hbm2_read_cmds,
				"samsung,panel-nv-mtp-read-hbm2-cmds");
	mdss_samsung_parse_panel_cmd(pdev, &nv_mtp_hbm3_read_cmds,
				"samsung,panel-nv-mtp-read-hbm3-cmds");
	mdss_samsung_parse_panel_cmd(pdev, &nv_hbm_elvss_offset_cmds,
				"samsung,panel-nv-hbm-elvss-offset-cmds");
	mdss_samsung_parse_panel_cmd(pdev, &nv_production_day_cmds,
